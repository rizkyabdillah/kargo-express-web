    ...
    <div class="card card-primary">
        <div class="card-header">
            ...
            <div class="card-header-action">
                <a href="<?= route_to('view_add_kota'); ?>" class="btn btn-primary">
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?= route_to('view_edit_kota', $arr[0]); ?>" class="btn btn-warning btn-action" data-toggle="tooltip" data-original-title="Ubah">
                                        <i class="fas fa-pencil-alt"></i>
                                    </a>
                                    <a data-id="<?= $arr[0]; ?>" class="btn btn-danger btn-action ml-1 swal_confirm" data-toggle="tooltip" data-original-title="Hapus">
                                        <form action="<?= route_to('delete_kota', $arr[0]); ?>" method="POST" id="hapus<?= $arr[0]; ?>" class="">
                                            <?= csrf_field(); ?>
