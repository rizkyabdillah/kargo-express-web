...
class IndexController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('index/contents/index', $data);
    }
    ...
    public function resi()
    {
        ...
        return view('index/contents/cek-resi', $data);
    }
    ...
    public function order()
    {
        ...
        return view('index/contents/order', $data);
    }

    public function orderLanjut()
    {
        ...
        return view('index/contents/order-lanjut', $data);
    }
    ...
    public function produk()
    {
        ...
        return view('index/contents/produk-layanan', $data);
    }
    ...
    public function tentang()
    {
        ...
        return view('index/contents/tentang-kami', $data);
    }
    ...
    public function cekPertama()
    {
        if (!$this->validate([
            ...
            return redirect()->to(route_to('order_lanjut'));
        }
    }
    ...
    public function orderFix()
    {
        ...
        session()->setFlashData('pesan1', 'Data order kargo berhasil disimpan, ' . $prefix . 'silahkan cek email anda untuk detail pembayaran');
        return redirect()->to(route_to('dashboard'));
    }

    public function invoice($resi)
    {

        $data_transaksi = $this->model->getRowDataArray('transaksi', ['no_resi' => $resi]);
        $data_pengirim = $this->model->getRowDataArray('info_pengirim', ['id_pengirim' => $data_transaksi['id_pengirim']]);
        $data_penerima = $this->model->getRowDataArray('info_penerima', ['id_penerima' => $data_transaksi['id_penerima']]);
        $data_barang = $this->model->getRowDataArray('info_barang', ['id_barang' => $data_transaksi['id_barang']]);
        $data_jalur = $this->model->getRowDataArray('VIEW_JALUR', ['id_jalur' => $data_transaksi['id_jalur']]);
        $data_detail = $this->model->getRowDataArray('VIEW_TRANSAKSI_DASHBOARD', ['no_resi' => $data_transaksi['no_resi']]);
        ...
        // return dd($data);
        return view('admin/contents/invoice', ['dataset' => $data]);
    }
    ...
    public function cekResi()
    {
        ...
        if ($transaksi) {
            $data_transaksi = $this->model->getRowDataArray('transaksi', ['no_resi' => $this->request->getVar('no_resi')]);
            $data_pengirim = $this->model->getRowDataArray('info_pengirim', ['id_pengirim' => $data_transaksi['id_pengirim']]);
            $data_penerima = $this->model->getRowDataArray('info_penerima', ['id_penerima' => $data_transaksi['id_penerima']]);
            $data_barang = $this->model->getRowDataArray('info_barang', ['id_barang' => $data_transaksi['id_barang']]);
            $data_jalur = $this->model->getRowDataArray('VIEW_JALUR', ['id_jalur' => $data_transaksi['id_jalur']]);
            $data_detail = $this->model->getRowDataArray('VIEW_DETAIL_TRANSAKSI', ['no_resi' => $data_transaksi['no_resi']]);
