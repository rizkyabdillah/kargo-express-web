...
<div class="card card-primary">
    ...
    <form method="POST" action="<?= route_to('update_jenis'); ?>" class="needs-validation" novalidate="">
        <?= csrf_field(); ?>
        <div class="card-body">
            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    ...
                    <input type="hidden" name="id" value="<?= $dataset['id_jenis']; ?>">
                    <input type="text" class="form-control <?= ($valid->hasError('jenis')) ? 'is-invalid' : ''; ?>" name="jenis" value="<?= (old('jenis')) ? old('jenis') : $dataset['jenis_barang']; ?>" placeholder="Jenis Barang">
