    ...
    <div class="card card-primary">
        <div class="card-header">
            ...
            <div class="card-header-action">
                <a href="<?= route_to('view_add_pegawai'); ?>" class="btn btn-primary">
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?= route_to('view_edit_pegawai', $arr[0]); ?>" class="btn btn-warning btn-action" data-toggle="tooltip" data-original-title="Ubah">
