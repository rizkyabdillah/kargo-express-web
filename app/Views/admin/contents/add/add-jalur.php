...
<div class="card card-primary">
    <div class="card-header">
        <h4>Form Tambah Jalur</h4>
    </div>
    <form method="POST" action="<?= route_to('save_jalur'); ?>" class="needs-validation" novalidate="">
        <?= csrf_field(); ?>
        <div class="card-body">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    echo form_dropdown('kota_awal', $data, old('kota_awal'), 'class="form-control selectric "');
                    ?>
                ...
                <div class="form-group col-md-6">
                    ...
                    echo form_dropdown('kota_tujuan', $data, old('kota_tujuan'), 'class="form-control selectric"');
