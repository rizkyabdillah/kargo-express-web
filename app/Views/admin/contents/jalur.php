                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?= route_to('view_edit_jalur', $arr[0]); ?>" class="btn btn-warning btn-action" data-toggle="tooltip" data-original-title="Ubah">
                                        <i class="fas fa-pencil-alt"></i>
                                    </a>
                                    <a data-id="<?= $arr[0]; ?>" class="btn btn-danger btn-action ml-1 swal_confirm" data-toggle="tooltip" data-original-title="Hapus">
                                        <form action="<?= route_to('delete_jalur', $arr[0]); ?>" method="POST" id="hapus<?= $arr[0]; ?>" class="">
                                            <?= csrf_field(); ?>
                                            <input type="hidden" name="_method" value="DELETE" />
                                        </form>
                                        <i class="fas fa-trash"></i>
                                    </a>
                                    <a href="<?= route_to('view_detail', $arr[0]); ?>" class="btn btn-info ml-1 btn-action" data-toggle="tooltip" data-original-title="Detail Jalur">
