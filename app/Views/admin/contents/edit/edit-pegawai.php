...
<div class="card card-primary">
    ...
    <form method="POST" action="<?= route_to('update_pegawai'); ?>" class="needs-validation" novalidate="">
        <?= csrf_field(); ?>
        <div class="card-body">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type=" text" class="form-control <?= ($valid->hasError('nama')) ? 'is-invalid' : ''; ?>" name="nama" value="<?= (old('nama')) ? old('nama') : $dataset['nama_pegawai']; ?>" placeholder="Nama Pegawai">
                ...
                <div class="form-group col-md-3">
                    ...
                    echo form_dropdown('jenis', $data, (old('jenis')) ? old('jenis') : $dataset['jenis_kelamin'], 'class="form-control selectric "');
                    ?>
                    <div class="invalid-feedback">
